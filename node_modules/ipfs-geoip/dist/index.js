...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(19), __webpack_require__(66).setImmediate))
...
const memoize = __webpack_require__(25)
const inet = __webpack_require__(81)
const mh = __webpack_require__(82)

const formatData = __webpack_require__(94)
...
const lookup = __webpack_require__(11)
const lookupPretty = __webpack_require__(95)
...
var normalizeOpts = __webpack_require__(12)
  , resolveLength = __webpack_require__(14)
  , plain         = __webpack_require__(30);
	...
	if (!options.normalizer) {
		...
		if (length !== 0) {
			if (options.primitive) {
				if (length === false) {
					options.normalizer = __webpack_require__(57);
				} else if (length > 1) {
					options.normalizer = __webpack_require__(58)(length);
				}
			} else if (length === false) options.normalizer = __webpack_require__(59)();
				else if (length === 1) options.normalizer = __webpack_require__(63)();
				else options.normalizer = __webpack_require__(64)(length);
		}
	}

	// Assure extensions
	if (options.async) __webpack_require__(65);
	if (options.promise) __webpack_require__(68);
	if (options.dispose) __webpack_require__(74);
	if (options.maxAge) __webpack_require__(75);
	if (options.max) __webpack_require__(78);
	if (options.refCounter) __webpack_require__(80);
...
var callable      = __webpack_require__(0)
  ...
  , configure     = __webpack_require__(32)
  , resolveLength = __webpack_require__(14);
...
var customError      = __webpack_require__(33)
  , defineLength     = __webpack_require__(16)
  , d                = __webpack_require__(6)
  , ee               = __webpack_require__(43).methods
  , resolveResolve   = __webpack_require__(44)
...
var iteratorSymbol = __webpack_require__(48).iterator
...
var objToString = Object.prototype.toString, id = objToString.call(__webpack_require__(13));
...
var aFrom        = __webpack_require__(8)
  , objectMap    = __webpack_require__(18)
  , mixin        = __webpack_require__(17)
  , defineLength = __webpack_require__(16)
...
var objectMap     = __webpack_require__(18)
  , primitiveSet  = __webpack_require__(69)
  , ensureString  = __webpack_require__(70)
  , toShortString = __webpack_require__(72)
...
var ensureValue   = __webpack_require__(4)
  , stringifiable = __webpack_require__(71);
...
var safeToString = __webpack_require__(73);
...
var aFrom      = __webpack_require__(8)
  ...
  , nextTick   = __webpack_require__(10)
  , isPromise  = __webpack_require__(21)
  , timeout    = __webpack_require__(76)
  , extensions = __webpack_require__(3);
...
var toPosInt   = __webpack_require__(2)
  , maxTimeout = __webpack_require__(77);
...
var toPosInteger = __webpack_require__(2)
  , lruQueue     = __webpack_require__(79)
  , extensions   = __webpack_require__(3);
...
const bs58 = __webpack_require__(86)

const cs = __webpack_require__(89)

exports.names = cs.names
exports.codes = cs.codes
exports.defaultLengths = cs.defaultLengths

const varint = __webpack_require__(90)
...
module.exports = {
    encode: __webpack_require__(91)
  , decode: __webpack_require__(92)
  , encodingLength: __webpack_require__(93)
}
